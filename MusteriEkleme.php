  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"> Müşteri Ekleme</h3>
					<ol class="breadcrumb">
						<li><a href="Anasayfa.php">Anasayfa</a></li>
						<li>Müşteri Ekleme</li>						  	
					</ol>
				</div>
			</div>
		   <div class="row">
                              ...
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="register_form" method="get" action="">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="inputAdres" name="inputAdres" type="text" />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                      ...
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <p class="btn btn-primary"  id="MusteriEkle">Kaydet</p>
                                              <a class="btn btn-default" href="MusteriEkleme.php" >İptal</a>
                                          </div>
                                      </div>
                                  </form>
                              </div>
  ...
  <script>
	...
	document.getElementById("AdSoyad").innerHTML = getCookie('AdSoyad').replace('+',' ');
		   	...
		   	$('#MusteriEkle').click(function() {
				...
				$.ajax({
					type: "POST",
					url: 'ajaxMusteriEkleme.php',                        
					dataType : 'json',
					data: form_data,
					success: function (data) {
								alert('Müşteri Ekleme İşlemi Başarıyla Tamamlandı');
							},
					error: function (sss) {
                                alert('Müşteri Ekleme İşleminde Hata Oluştur');
							}
					  });
				});
