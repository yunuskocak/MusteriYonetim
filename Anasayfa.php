 ...
 * Time: 17:48
 */
$title="Personel Ana Sayfasý";
//require_once 'Include/Baslik.php';
require_once(__DIR__.'/Model/AkademikPersonel.class.php'); // Session icerisindeki nesnenin oluþturulabilmesi için gerekli
...
<!DOCTYPE html>
<head>
    <title>Öðrenci Bilgi Sistemi</title>
    <meta charset="UTF-8">
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="#">Öðrenci Bilgi Sistemi</a>
        </div>
        <ul class="nav navbar-nav">
            <li class="active"><a href="#">Giriþ Sayfasý</a></li>

            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Öðrenci Ýþlemleri <span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="#" id="ogrenciArama">Arama</a></li>
                    <li><a href="#" id="ogrenciEkleme">Ekleme</a></li>
                    <li><a href="#">Silme</a></li>
                    <li role="separator" class="divider"></li>
                    <li class="dropdown-header">Ders Ýþlemleri</li>
                    <li><a href="#">Ders Kayýt</a></li>
                    <li><a href="#">Not Giriþi</a></li>
                </ul>
            </li>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="#">Þifre Deðiþtir</a></li>
                    <li><a href="Include/Cikis.php">  <span class="glyphicon glyphicon-log-out" style="alignment: "></span> &nbsp; Çýkýþ</a></li>
                </ul>
            </li>
    ...
    <div class="row" >
        <div class="col-md-10 ">
            <div class="panel panel-default" id="icerik">
                <div class="panel-heading" >Giriþ Sayfasý
                </div>

                <div class="panel-body" > Giriþ Sayfasý   </div>
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body" id="messages1" style="max-height: 200px">
                    ...
                    <!--Library/NodeJS klasöründeki sunucu baþlatýlmalý-->
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body"  style="max-height: 200px">
                    <input type="text" id="m" class="form-control input-sm" placeholder="Mesajýnýz"/>
...
<footer id="footer" class="footer">
    <div class="container">
        <p class="text-muted">Öðrenci Bilgi Sistemi</p>
    </div>
</footer>
