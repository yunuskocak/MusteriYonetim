...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index.html">Müşteri Yönetim</a>
            <!--logo end-->
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href="login.php"><i class="icon_key_alt"></i> Çıkış</a>
                            </li>
                        </ul>
                    </li>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">  
				  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          <li><a class="" href="form_component.html">Müşteri Ekleme</a></li>                          
                          <li><a class="" href="form_validation.html">Müşteri Güncelleme</a></li>
                          <li><a class="" href="form_validation.html">Müşteri Silme</a></li>
                      </ul>
                  </li>       
				  <li class="sub-menu">
                  <li>                     
